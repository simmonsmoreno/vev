                ...
                <div className="container-bg bg-dark-blue">
                  <div className="container">
                    <div className="gallery-filter-area row">
                      ...
                      {/* gallery-item */}
                      <div className="tp-gallery-item col-sm-6 mb-10">
                        <div className="tp-gallery-item-img">
                          <div className="thumbnails">
                            <img src={viaje.url} alt="imagem" />
                            <div className="video-popup-btn">
                              <a href="https://www.youtube.com/watch?v=Quon7oyy60A" className="video-play-btn mfp-iframe" tabIndex={0}><i className="fa fa-play" /></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      {/* gallery-item
                      {
                        viaje.photos !== undefined && viaje.photos.map(photo => (
                          <div className="tp-gallery-item col-md-3 col-sm-6" key={photo.id}>
                            <div className="tp-gallery-item-img">
                              <Link data-effect="mfp-zoom-in" to="#">
                                <img width={300} height={200} src={photo.url} alt="imagem" />
                              </Link>
                            </div>
                          </div>
                        ))
                    ...
                    <div className="row">
                      ...
                      <div className="col-xl-9 col-lg-8">
                        ...
                        <ul className="tp-list-meta border-tp-solid">
                          <li className="ml-0"><i className="fa fa-calendar-o" />
                            {
                              new Date(viaje.fecha).toLocaleString('es', { month: 'long', day: 'numeric' })
                            }
                          </li>
                          {/* <li><i className="fa fa-clock-o" /> 9pm</li> */}
                          <li><i className="fa fa-clock-o" /> {viaje.hora} {viaje.salida}</li>
                        ...
                        <div className="destinations-details-main-slider-controls">
                          ...
                          <div className="slider-extra tp-slider-extra">
                            <div className="text">
                              ...
                              <span className="last">{viaje.photos.length + 1}</span>
                            </div>
                            {/*text*/}
