                ...
                <div className="row">
                  <div className="col-lg-5 align-self-center">
                    <div className="section-title mb-lg-0">
                      <h2 className="title">Viaja <br /> con nosotros</h2>
                  ...
                  <div className="col-lg-5 offset-lg-2">
                    <div className="thumb about-section-right-thumb">
                      <img src={publicUrl+"assets/img/viajes-erasmus-3.jpg"} alt="img" />
                      <img className="about-absolute-thumb" src={publicUrl+"assets/img/viajes-erasmus-2.jpg"} alt="img" />
                    </div>
                  </div>
                </div>
              </div>
